...
class HRA(db.Model):
	...
	def to_dict(self):
		...
		meta_keys = ["responseID", "USER_UPDATED", "DATE_UPDATED", "USER_CREATED", "DATE_CREATED", "tcid", "surveyID", "completed"]
		score_keys = ["Overall", "Tobacco", "Diet & Nutrition", "Physical Activity", "Stress", "Preventative care"]
