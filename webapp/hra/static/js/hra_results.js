...
var export_to_pdf = function(){
	...
	var user_key_img = "<img id='user_key_img' src='/hra/static/media/user_bar_key.png'/>";
	$("#user_score_key").after(user_key_img);
	$("#user_score_key").remove();
	var tc_key_img = "<img id='tc_key_img' src='/hra/static/media/tc_bar_key.png'/>";
	...
	$("input[type='radio']").each(function(){
		if($(this).attr("checked")){
			$(this).after("<img class='temp_input' src='/hra/static/media/checked_radio.png'>");
		} else {
			$(this).after("<img class='temp_input' src='/hra/static/media/unchecked_radio.png'>");
		}
	});
	$("input[type='checkbox']").each(function(){
		if($(this).attr("checked")){
			$(this).after("<img class='temp_input' src='/hra/static/media/checked_checkbox.png'>");
		} else {
			$(this).after("<img class='temp_input' src='/hra/static/media/unchecked_checkbox.png'>");
		}
	});
...
var convert_to_pdf = function(html_data, filename, callback){
	...
	xhr.open("POST", "/util/convert_html_to_pdf");
